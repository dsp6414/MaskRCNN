...
dataset      = BasicDataset('', get_transform(train=True))
dataset_test = BasicDataset('', get_transform(train=True))

###########################################################################################

dir_checkpoint = '/content/weights/' # Directory of checkpoints or saved weights
